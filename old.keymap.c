...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, 	KC_LGUI, KC_LALT,LOWER, KC_MINS, KC_SPC,  KC_SPC,  KC_QUOT, RAISE,   KC_RALT, XXXXXXX, KC_RCTL
),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, RESET,   DEBUG,   RGB_TOG, RGB_MOD, CL_NORM, CL_SWAP, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
